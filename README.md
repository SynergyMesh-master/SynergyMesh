...
| 原則           | 說明                                                 |
| -------------- | ---------------------------------------------------- |
| **統一入口**   | 單一配置檔 `machinenativeops.yaml`（相容連結：`machine-native-ops.yaml`、`synergymesh.yaml`）作為所有系統的真實來源 |
...
unmanned-island/
│
├── machinenativeops.yaml         # 🔑 統一主配置入口（相容連結：machine-native-ops.yaml, synergymesh.yaml）
│
├── core/                         # 🏛️ 核心平台服務
...
| 配置檔案                          | 說明                             |
|-----------------------------------|----------------------------------|
| machinenativeops.yaml            | 統一主配置入口（兼容連結：machine-native-ops.yaml, synergymesh.yaml） |
